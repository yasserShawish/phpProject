...
<head>
    ...
    <!-- Custom CSS -->
    <link  href="../../Content/adminCss/sb-admin.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link  href="../../Content/adminCss/plugins/morris.css" rel="stylesheet">
...
<body>
    ...
    <!-- jQuery -->
     <script src="../../Content/js/jsAdmin/jquery.js"></script>

    <!-- Bootstrap Core JavaScript -->
     <script src="../../Content/js/jsAdmin/bootstrap.min.js"></script>

    <!-- Morris Charts JavaScript -->
     <script src="../../Content/js/jsAdmin/plugins/morris/raphael.min.js"></script>
     <script src="../../Content/js/jsAdmin/plugins/morris/morris.min.js"></script>
     <script src="../../Content/js/jsAdmin/plugins/morris/morris-data.js"></script>

    <!-- Flot Charts JavaScript -->
    <!--[if lte IE 8]> <script src="../../Content/js/jsAdmin/excanvas.min.js"></script><![endif]-->
     <script src="../../Content/js/jsAdmin/plugins/flot/jquery.flot.js"></script>
     <script src="../../Content/js/jsAdmin/plugins/flot/jquery.flot.tooltip.min.js"></script>
     <script src="../../Content/js/jsAdmin/plugins/flot/jquery.flot.resize.js"></script>
     <script src="../../Content/js/jsAdmin/plugins/flot/jquery.flot.pie.js"></script>
     <script src="../../Content/js/jsAdmin/plugins/flot/flot-data.js"></script>
